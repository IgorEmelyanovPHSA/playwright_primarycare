...
test('Can_Add_Current_Staff_to_Directors_Clinic_in_Portal', async ({ page }) => {
  //Remove Kristine Fisher from Clinic stuff first.
  ...
  //Adding Staff Member "Kristine Fisher" as an Provider to Clinic
  ...
  // Manage Access -> checkbox "Manage Fasility" for Kristine Fisher in Details.
