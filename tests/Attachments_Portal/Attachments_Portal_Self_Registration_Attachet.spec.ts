...
await page.getByRole('textbox', { name: 'Postal code' }).click({button: 'right'});
await page.getByRole('textbox', { name: 'Postal code' }).fill('V6Y 1A3');
await page.locator('#content-251').click();
await page.getByRole('button', { name: 'Continue' }).click();
//await page.getByRole('textbox', { name: 'Email address' }).click({button: 'right'});
...
await page.getByRole('textbox', { name: 'Confirm email address' }).click({button: 'right'});
...
//await page.getByRole('textbox', { name: 'Mobile phone number' }).click({button: 'right'});
...
//await page.getByRole('textbox', { name: 'Communication preference' }).click({button: 'right'});
